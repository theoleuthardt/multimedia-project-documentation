...
\include{kapitel/01projektbeschreibung}
\include{kapitel/02zielgruppe}
\include{kapitel/03nachricht}
\include{kapitel/04medienpsychologie}
\include{kapitel/05entwurf}
\include{kapitel/06drehbuch}
\include{kapitel/07technik}
\include{kapitel/08screendumps}
