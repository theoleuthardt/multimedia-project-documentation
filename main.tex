...
\newcommand{\type}{Praxistransferbericht I/II/III oder Studienprojekt I/II} % oder Bachelorarbeit
\newcommand{\topic}{Titel}
\newcommand{\subtopic}{Untertitel}
\newcommand{\studentName}{Vorname Name} % mehrere Autoren: {Vorname Name, Vorname Name} etc
\newcommand{\matrikelNr}{7220XXXXXXX}   % mehrere Autoren: {7220XXXXXXX, 7220XXXXXXX}
\newcommand{\company}{Unternehmen}
\newcommand{\jahrgang}{20XX}
\newcommand{\fachbereich}{Duales Studium Wirtschaft · Technik}
\newcommand{\studiengang}{Informatik}
\newcommand{\betreuerHS}{(Akademischer Titel) Vorname Name}
\newcommand{\betreuerUnt}{(Akademischer Titel) Vorname Name}
...
\titlehead{\begin{center}
    ...
    \hfill
    \includegraphics[height=0.04\textheight]{bilder/FUBIT.png} % hier DEIN Firmenlogo
    \end{center}
    }
...
\include{kapitel/02aufzählungen}
\include{kapitel/03akronyme}
\include{kapitel/04quellen}
\include{kapitel/05abbildungen}
\include{kapitel/06tabellen}
\include{kapitel/07gliederung}
